...
<body>
	...
	<div class="topnav">
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<?php if($_SESSION['uid']> 0): ?><li><?php echo (session('uname')); ?>您好，欢迎来到京西！[<a href="<?php echo U('User/logout');?>">退出</a>]</li>
					<?php else: ?>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="nav w1210 bc mt10">
			<!--  商品分类部分 start-->
			<?php if(CONTROLLER_NAME== 'Index' and ACTION_NAME== 'index'): ?><div class="catgory fl"> <!-- 非首页，需要添加cat1类 -->
	...
	<style type="text/css">
		/*购物车弹出框*/
		.orange{color: #CC0000;}
		a.bt_orange:link,a.bt_orange:visited{color:#FFFFFF;width:107px; height:27px; line-height:27px;background:url(/Public/Home/images/chakanBtn.jpg) no-repeat; text-align:center; font-weight:bold;cursor:pointer; display:block; _display:inline; float:left; margin-left:60px;}
		a.bt_blue:link,a.bt_blue:visited{color:#FFFFFF;width:107px; height:27px; line-height:27px;background:url(/Public/Home/images/tiaoxuannBtn.jpg) no-repeat; text-align:center; font-weight:bold;cursor:pointer;display:block;_display:inline; float:right; margin-right:60px;}
		...
		.buy_blank h4{ border-bottom:2px solid #D0D0D0; font-weight:normal; height:30px; line-height:30px;background:url(/Public/Home/images/buyicon.jpg) no-repeat 10px center; text-indent:28px; margin-bottom:10px; padding-left:20px;}
    ...
    <div class="buy_blank" id="cartBox" style="display:none;z-index:99;">
        <h4>
            <span><a href="javascript:;" onclick="hideElement('cartBox')"><img src="/Public/Home/images/close.jpg" title="点击关闭"/></a></span>
            该商品已成功添加到购物车
        </h4>
        ...
        <p>
            <a href="<?php echo U('Cart/flow1');?>" onclick="javascript:hideElement('cartBox')" class="bt_orange" target="_black"></a>
			...
			<div class="summary">
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="market_price"><span>定价：</span><em>￥<?php echo ($data['goods_price'] + 1000); ?></em></li>
						<li class="shop_price"><span>本店价：</span> <strong>￥<?php echo ($data["goods_price"]); ?></strong> <a href="">(降价通知)</a></li>
						<li><span>上架时间：</span><?php echo (date('Y-m-d',$data["add_time"])); ?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
					<form action="" method="post" class="choose">
						<ul>
							<?php if(is_array($attrs)): $i = 0; $__LIST__ = $attrs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><li class="product">
								<dl>
									<dt><?php echo ($vol["attr_name"]); ?>：</dt>
									<dd>
										<?php if(is_array($vol["attr_vals"])): $i = 0; $__LIST__ = $vol["attr_vals"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a <?php if($key == 0): ?>class="selected"<?php endif; ?> href="javascript:;"><?php echo ($vo); ?><input type="radio" name="color" value="<?php echo ($vo); ?>" checked="checked" /></a><?php endforeach; endif; else: echo "" ;endif; ?>
									</dd>
								</dl>
...
<input type="button" value="" class="add_btn" id='add_btn' onclick="add_cart(<?php echo ($data["goods_id"]); ?>)" />
									</dd>
								</dl>
							</li>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
								<?php if(is_array($single)): $i = 0; $__LIST__ = $single;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sig): $mod = ($i % 2 );++$i;?><li><span><?php echo ($sig["attr_name"]); ?>：</span><?php echo ($sig["attr_value"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
							</ul>
						</div>
